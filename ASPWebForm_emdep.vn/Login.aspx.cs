...
namespace ASPWebForm_emdep.vn
{
    public partial class Login : System.Web.UI.Page
    {
        ...
        protected void lbtDangNhap_Click(object sender, EventArgs e)
        {
            ...
            DataTable dt = ASPWebForm_emdep.vn.App_Code.Database.DangKy.Thongtin_DangKy_by_id_matkhau(tbTenDangNhap.Text,
                ASPWebForm_emdep.vn.App_Code.MaHoa.MaHoaMD5(tbMatKhau.Text));
            if (dt.Rows.Count > 0)
            {
