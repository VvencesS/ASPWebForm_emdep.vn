<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TrangChuLoadControl.ascx.cs" Inherits="ASPWebForm_emdep.vn.cms.display.TrangChu.TrangChuLoadControl" %>
<div id="slideshow">
    ...
    <div id="sanphamnoibat">
        ...
        <div class="sp_noibat">
            <div class="item">
                ...
                <a class="title-sp" href="#" title="yếm bò">Yếm bò sooc
                </a>
                <div class="desc">
                    yếm sooc bò nữ
                </div>
