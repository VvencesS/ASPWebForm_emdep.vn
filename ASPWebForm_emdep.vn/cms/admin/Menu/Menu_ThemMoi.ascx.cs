...
namespace ASPWebForm_emdep.vn.cms.admin.Menu
{
    public partial class Menu_ThemMoi : System.Web.UI.UserControl
    {
        ...
        private void HienThiThongTin(string id)
        {
            if (thaotac == "ChinhSua")
            {
                ...
                dt = ASPWebForm_emdep.vn.App_Code.Database.Menu.Thongtin_Menu_by_id(id);
                if (dt.Rows.Count > 0)
                {
        ...
        {
            DataTable dt = new DataTable();
            dt = ASPWebForm_emdep.vn.App_Code.Database.Menu.Thongtin_Menu_by_MaMenuCha(MaMenuCha);
        ...
        protected void btThemMoi_Click(object sender, EventArgs e)
        {
            if (thaotac == "ThemMoi")
            {
                ...
                ASPWebForm_emdep.vn.App_Code.Database.Menu.Menu_Inser(
            ...
            else
            {
                ...
                ASPWebForm_emdep.vn.App_Code.Database.Menu.Menu_Update(id, tbTenMenu.Text, tbLienKet.Text,
                    ddlMenuCha.SelectedValue, tbThuTu.Text);
