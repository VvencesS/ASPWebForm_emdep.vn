    ...
    public partial class ChatLieu_ThemMoi : System.Web.UI.UserControl
    {
        ...
        private void HienThiThongTin(string id)
        {
            if (thaotac == "ChinhSua")
            {
                ...
                dt = ASPWebForm_emdep.vn.App_Code.Database.ChatLieu.Thongtin_ChatLieu_by_id(id);
                if (dt.Rows.Count > 0)
                {
        ...
        protected void btThemMoi_Click(object sender, EventArgs e)
        {
            if (thaotac == "ThemMoi")
            {
                ...
                ASPWebForm_emdep.vn.App_Code.Database.ChatLieu.Chatlieu_Inser(tbTenChatLieu.Text, "");
            ...
            else
            {
                ...
                ASPWebForm_emdep.vn.App_Code.Database.ChatLieu.Chatlieu_Update(id, tbTenChatLieu.Text);
