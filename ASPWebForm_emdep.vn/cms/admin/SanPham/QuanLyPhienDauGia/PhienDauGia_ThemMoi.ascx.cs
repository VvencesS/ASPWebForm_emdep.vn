...
namespace ASPWebForm_emdep.vn.cms.admin.SanPham.QuanLyPhienDauGia
{
    public partial class PhienDauGia_ThemMoi : System.Web.UI.UserControl
    {
        ...
        private void HienThiThongTin(string id)
        {
            if (thaotac == "ChinhSua")
            {
                ...
                dt = ASPWebForm_emdep.vn.App_Code.Database.PhienDauGia.Thongtin_PhienDauGia_by_id(id);
                if (dt.Rows.Count > 0)
                {
        ...
        protected void btThemMoi_Click(object sender, EventArgs e)
        {
            if (thaotac == "ThemMoi")
            {
                ...
                ASPWebForm_emdep.vn.App_Code.Database.PhienDauGia.PhienDauGia_Inser(tbThoiGianBatDau.Text, tbThoiGianKetThuc.Text, tbMaSP.Text, tbGiaDeXuat.Text, "");
            ...
            else
            {
                ...
                ASPWebForm_emdep.vn.App_Code.Database.PhienDauGia.PhienDauGia_Update(id, tbThoiGianBatDau.Text, tbThoiGianKetThuc.Text, tbMaSP.Text, tbGiaDeXuat.Text);
