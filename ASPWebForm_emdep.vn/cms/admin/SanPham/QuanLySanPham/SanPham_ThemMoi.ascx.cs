...
namespace ASPWebForm_emdep.vn.cms.admin.SanPham.QuanLySanPham
{
    public partial class SanPham_ThemMoi : System.Web.UI.UserControl
    {
        ...
        private void HienThiThongTin(string id)
        {
            ...
            else
            {
                ...
                tbNgayTao.Text = DateTime.Now.ToString("yyyy/MM/dd hh:mm:ss tt");
                tbNgayHuy.Text = DateTime.Now.ToString("yyyy/MM/dd hh:mm:ss tt");
            }
        ...
        {
            DataTable dt = new DataTable();
            dt = ASPWebForm_emdep.vn.App_Code.Database.Mau.Thongtin_Mau();
            ddlMau.Items.Clear();
        ...
        {
            DataTable dt = new DataTable();
            dt = ASPWebForm_emdep.vn.App_Code.Database.ChatLieu.Thongtin_Chatlieu();
        ...
        {
            DataTable dt = new DataTable();
            dt = ASPWebForm_emdep.vn.App_Code.Database.NhomSanPham.Thongtin_Nhomsp();
            ddlNhom.Items.Clear();
        ...
        protected void btThemMoi_Click(object sender, EventArgs e)
        {
            if (thaotac == "ThemMoi")
            {
                ...
                ASPWebForm_emdep.vn.App_Code.Database.SanPham.Sanpham_Inser(tbTenSanPham.Text, ddlMau.SelectedValue, ddlSize.SelectedValue, ddlChatLieu.SelectedValue, flAnhDaiDien.FileName, tbSoLuong.Text, tbGiaBan.Text, tbMoTa.Text, DateTime.Parse(tbNgayTao.Text), DateTime.Parse(tbNgayHuy.Text), ddlDanhMucCha.SelectedValue, ddlNhom.SelectedValue, "");
