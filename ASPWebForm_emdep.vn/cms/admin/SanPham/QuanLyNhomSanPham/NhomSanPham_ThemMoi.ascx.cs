...
namespace ASPWebForm_emdep.vn.cms.admin.SanPham.QuanLyNhomSanPham
{
    public partial class NhomSanPham_ThemMoi : System.Web.UI.UserControl
    {
        ...
        private void HienThiThongTin(string id)
        {
            if (thaotac == "ChinhSua")
            {
                ...
                dt = ASPWebForm_emdep.vn.App_Code.Database.NhomSanPham.Thongtin_Nhomsp_by_id(id);
                if (dt.Rows.Count > 0)
                {
        ...
        protected void btThemMoi_Click(object sender, EventArgs e)
        {
            if (thaotac == "ThemMoi")
            {
                ...
                ASPWebForm_emdep.vn.App_Code.Database.NhomSanPham.Nhomsanpham_Inser(tbTenNhomSP.Text, flAnhDaiDien.FileName, tbThuTu.Text, tbSoSanPhamHienThi.Text, "");
            ...
            else
            {
                ...
                ASPWebForm_emdep.vn.App_Code.Database.NhomSanPham.Nhomsanpham_Update(id, tbTenNhomSP.Text, tenAnhDaiDien, tbThuTu.Text, tbSoSanPhamHienThi.Text);
