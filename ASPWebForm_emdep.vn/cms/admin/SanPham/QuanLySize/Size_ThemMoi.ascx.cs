...
namespace ASPWebForm_emdep.vn.cms.admin.SanPham.QuanLySize
{
    public partial class Size_ThemMoi : System.Web.UI.UserControl
    {
        ...
        private void HienThiThongTin(string id)
        {
            if (thaotac == "ChinhSua")
            {
                ...
                dt = ASPWebForm_emdep.vn.App_Code.Database.Size.Thongtin_Size_by_id(id);
                if (dt.Rows.Count > 0)
                {
        ...
        protected void btThemMoi_Click(object sender, EventArgs e)
        {
            if (thaotac == "ThemMoi")
            {
                ...
                ASPWebForm_emdep.vn.App_Code.Database.Size.Size_Inser(tbTenSize.Text, "");
            ...
            else
            {
                ...
                ASPWebForm_emdep.vn.App_Code.Database.Size.Size_Update(id, tbTenSize.Text);
