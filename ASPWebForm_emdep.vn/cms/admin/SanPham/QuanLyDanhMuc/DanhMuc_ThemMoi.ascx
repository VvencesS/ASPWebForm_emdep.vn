<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DanhMuc_ThemMoi.ascx.cs" Inherits="ASPWebForm_emdep.vn.cms.admin.SanPham.QuanLyDanhMuc.DanhMuc_ThemMoi" %>
<div class="head">
...
<div class="FormThemMoi">
    ...
    <div class="thongTin">
        ...
        <div class="oNhap">
            <asp:DropDownList ID="ddlDanhMucCha" runat="server"></asp:DropDownList></div>
    </div>
    <div class="thongTin">
    ...
    <div class="thongTin">
        ...
        <div class="oNhap">
            <asp:CheckBox ID="cbThemNhieuDanhMuc" runat="server" Text="Tạo thêm danh mục khác sau khi tạo danh mục này" /></div>
    </div>
    <div class="thongTin">
        <div class="tenTruong">&nbsp;</div>
        <div class="oNhap">
