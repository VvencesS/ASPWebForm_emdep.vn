...
namespace ASPWebForm_emdep.vn.cms.admin.SanPham.QuanLyMau
{
    public partial class Mau_ThemMoi : System.Web.UI.UserControl
    {
        ...
        private void HienThiThongTin(string id)
        {
            if (thaotac == "ChinhSua")
            {
                ...
                dt = ASPWebForm_emdep.vn.App_Code.Database.Mau.Thongtin_Mau_by_id(id);
                if (dt.Rows.Count > 0)
                {
        ...
        protected void btThemMoi_Click(object sender, EventArgs e)
        {
            if (thaotac == "ThemMoi")
            {
                ...
                ASPWebForm_emdep.vn.App_Code.Database.Mau.Mau_Inser(tbTenMau.Text, "");
            ...
            else
            {
                ...
                ASPWebForm_emdep.vn.App_Code.Database.Mau.Mau_Update(id, tbTenMau.Text);
