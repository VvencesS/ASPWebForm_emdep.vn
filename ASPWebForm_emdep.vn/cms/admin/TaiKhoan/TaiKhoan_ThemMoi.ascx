<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TaiKhoan_ThemMoi.ascx.cs" Inherits="ASPWebForm_emdep.vn.cms.admin.TaiKhoan.TaiKhoan_ThemMoi" %>
<div class="head">
...
<div class="FormThemMoi">
    ...
    <div class="thongTin">
        ...
        <div class="oNhap">
            <asp:DropDownList ID="ddlQuyenDangNhap" runat="server"></asp:DropDownList></div>
    </div>
    <div class="thongTin">
    ...
    <div class="thongTin">
        <div class="tenTruong">Ngày sinh (Năm/Tháng/Ngày)</div>
        <div class="oNhap">
    ...
    <div class="thongTin">
        ...
        <div class="oNhap">
            <asp:CheckBox ID="cbThemNhieuDanhMuc" runat="server" Text="Tạo thêm tài khoản khác sau khi tạo tài khoản này" /></div>
    </div>
    <div class="thongTin">
        <div class="tenTruong">&nbsp;</div>
        <div class="oNhap">
