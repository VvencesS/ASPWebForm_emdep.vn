...
namespace ASPWebForm_emdep.vn.cms.admin.QuangCao.QuanLyDanhSachQuangCao
{
    public partial class DanhSachQuangCao_ThemMoi : System.Web.UI.UserControl
    {
        ...
        private void HienThiThongTin(string id)
        {
            if (thaotac == "ChinhSua")
            {
                ...
                dt = ASPWebForm_emdep.vn.App_Code.Database.QuangCao.Thongtin_Quangcao_by_id(id);
                if (dt.Rows.Count > 0)
                {
        ...
        {
            DataTable dt = new DataTable();
            dt = ASPWebForm_emdep.vn.App_Code.Database.NhomQuangCao.Thongtin_Nhomquangcao();
        ...
        protected void btThemMoi_Click(object sender, EventArgs e)
        {
            if (thaotac == "ThemMoi")
            {
                ...
                ASPWebForm_emdep.vn.App_Code.Database.QuangCao.Quangcao_Inser(
            ...
            else
            {
                ...
                ASPWebForm_emdep.vn.App_Code.Database.QuangCao.Quangcao_Update(
