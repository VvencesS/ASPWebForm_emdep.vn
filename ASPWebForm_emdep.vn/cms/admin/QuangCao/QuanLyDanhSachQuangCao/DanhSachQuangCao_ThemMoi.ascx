<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="DanhSachQuangCao_ThemMoi.ascx.cs" Inherits="ASPWebForm_emdep.vn.cms.admin.QuangCao.QuanLyDanhSachQuangCao.DanhSachQuangCao_ThemMoi" %>
<div class="head">
