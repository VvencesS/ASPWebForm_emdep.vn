<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NhomQuangCao_ThemMoi.ascx.cs" Inherits="ASPWebForm_emdep.vn.cms.admin.QuangCao.QuanLyNhomQuangCao.NhomQuangCao_ThemMoi" %>
<div class="head">
