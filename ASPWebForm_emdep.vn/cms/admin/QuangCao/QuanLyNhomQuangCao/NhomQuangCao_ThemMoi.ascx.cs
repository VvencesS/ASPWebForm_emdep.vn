...
namespace ASPWebForm_emdep.vn.cms.admin.QuangCao.QuanLyNhomQuangCao
{
    public partial class NhomQuangCao_ThemMoi : System.Web.UI.UserControl
    {
        ...
        private void HienThiThongTin(string id)
        {
            if (thaotac == "ChinhSua")
            {
                ...
                dt = ASPWebForm_emdep.vn.App_Code.Database.NhomQuangCao.Thongtin_Nhomquangcao_by_id(id);
                if (dt.Rows.Count > 0)
                {
        ...
        protected void btThemMoi_Click(object sender, EventArgs e)
        {
            if (thaotac == "ThemMoi")
            {
                ...
                ASPWebForm_emdep.vn.App_Code.Database.NhomQuangCao.Nhomquangcao_Inser(tbTenNhomQC.Text, tbViTriQC.Text, tbThuTu.Text, flAnhDaiDien.FileName, "");
            ...
            else
            {
                ...
                ASPWebForm_emdep.vn.App_Code.Database.NhomQuangCao.Nhomquangcao_Update(id, tbTenNhomQC.Text, tbViTriQC.Text, tbThuTu.Text, flAnhDaiDien.FileName);
