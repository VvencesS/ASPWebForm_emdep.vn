...
namespace ASPWebForm_emdep.vn.cms.admin.QuangCao.QuanLyNhomQuangCao.Ajax
{
    public partial class NhomQuangCao : System.Web.UI.Page
    {
        ...
        private void XoaNhomQuangCao()
        {
            ...
            if (Request.Params["NhomQuangCaoID"] != null)
            {
                ...
                ASPWebForm_emdep.vn.App_Code.Database.NhomQuangCao.Nhomquangcao_Delete(NhomQuangCaoID);
