...
namespace ASPWebForm_emdep.vn.App_Code.Database
{
    ...
    public class TinTuc
    {
        ...
        {
            SqlCommand cmd = new SqlCommand("tintuc_delete");
        ...
        {
            SqlCommand cmd = new SqlCommand("thongtin_tintuc");
            cmd.CommandType = CommandType.StoredProcedure;
        ...
        {
            SqlCommand cmd = new SqlCommand("thongtin_tintuc_by_id");
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@TinTucID", TinTucID);
            return SQLDatabase.GetData(cmd);
        }
        ...
        {
            SqlCommand cmd = new SqlCommand("thongtin_tintuc_by_madm");
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@MaDM", MaDM);
            return SQLDatabase.GetData(cmd);
        }
        ...
        {
            SqlCommand cmd = new SqlCommand("thongtin_tintuc_by_madm_tatca");
            cmd.CommandType = CommandType.StoredProcedure;
            cmd.Parameters.AddWithValue("@MaDM", MaDM);
            return SQLDatabase.GetData(cmd);
        }
        ...
        {
            SqlCommand cmd = new SqlCommand("CapNhatLuotXemTinTuc");
            cmd.CommandType = CommandType.StoredProcedure;
